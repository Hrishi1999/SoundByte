...
namespace SoundByte.UWP.Brushes
{
    public abstract class AcrylicBrushBase : XamlCompositionBrushBase
    {
        ...
        protected override void OnConnected()
        {
            ...
            var visual = ElementCompositionPreview.GetElementVisual(Window.Current.Content);
            ElementCompositionPreview.SetIsTranslationEnabled(Window.Current.Content, true);
